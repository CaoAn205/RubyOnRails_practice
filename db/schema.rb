...
ActiveRecord::Schema.define(version: 2020_09_08_084038) do
  ...
  create_table "followeds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "follow_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["follow_id"], name: "index_followeds_on_follow_id"
  ...
  add_foreign_key "followeds", "follows"
